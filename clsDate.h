...
public:
    ...
    clsDate IncreaseDateByOneMonth(clsDate &Date)
    {
        ...
        // Last check: adjust day if it exceeds number of days in the new month
    ...
    {
        // Modifies the current object (*this) and returns it
    ...
    static short DaysUntilTheEndOfMonth(clsDate Date1)
    {
        ...
        // Set the EndOfMonthDate day to the last day of the current month
